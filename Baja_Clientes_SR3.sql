...
into entregas22.dbo.resvtaprvdia_ped_202206
from reportes.resvtaprvdia_ped a
where fecvta>='20220501' and fecvta<='20220630'and codmesa in (select code from "@BKS_MESA" where u_bks_estado ='Y' and code not in ('000','002'))
...
into entregas22..Bajas_Junio2022
...
and exists (select 1 from ocrd x where x.CardCode=a.U_BKP_CLIENTE and x.CreateDate <'20220701')
...
Select * 
Into Entregas22.dbo.gCAR1_Junio2022 
From gProc.gCAR1 
where exists (select 1 from gProc.gCAR where gProc.gCAR1.id=gProc.gCAR.id and docdate between '20220701' and '20220707')

delete from gProc.gCAR1 
where exists (select 1 from gProc.gCAR where gProc.gCAR1.id=gProc.gCAR.id and docdate between '20220701' and '20220707')

Select * Into Entregas22.dbo.gCar_Junio2022 From gProc.gCAR where docdate>='20220701'

Select * 
--Delete
from gProc.gCAR1 Where id In (Select Id from gProc.gCAR where docdate>='20220701')

delete from gProc.gCAR where docdate>='20220701'
...
Select * From Entregas22.dbo.gCar_Junio2022 
